    ...
    if (url.searchParams.has('exibirModal')) {
        ...
        if (valorExibirModal === '1') {
            advancedAlerts.success({
                title: "<b>NOVIDADE!</b>",
                text: "<img src='https://autoconecta.com.br/assets/images/dark-logo.png' style='max-width: 56%;height: auto;' alt='Imagem/Logo da AutoConecta'><br><p>A Seminovos em parceria com o <strong style='color: #2081C3;'>Auto Conecta</strong>, oferece aos nossos parceiros o REPASSE AUTO CONECTA... Uma plataforma para cadastrar seus veículos de \"repasse\" e conecta você com todas as empresas parceiras ativas da Seminovos!</p></br><p>Fique tranquilo, essa ferramenta só lojistas tem acesso! Seu estoque de repasse, sendo visualizado por mais de 600 lojas.</p></br><p style='text-align:center;'><strong style='color:red;'>Atenção: <br> Para entrar na plataforma, utilize o seu e-mail principal registrado na Seminovos e a senha correspondente.</strong></p><a target='_blank' href='https://autoconecta.com.br/auth/login' style='margin-top: 30px;background-color: #2081C3;margin-bottom: -30px;border-color: #2081C3;' class='btn btn-sm btn-info text-white d-flex align-items-center w-100 justify-content-center btn-acao-trocar-plano'>CLIQUE PARA ACESSAR O REPASSE AUTO CONECTA</a>",
                time: 0,
                close: "",
            });
        }
