                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.historicoCarro && response.historicoCarro.dados_veiculo) {
                                ...
                                if (
                                    historico.dados_veiculo.ano_modelo &&
                                    (parseInt(historico.dados_veiculo.ano_modelo) || false)
                                ) {
                                    //seta ano do modelo
                                ...
                                if (
                                    ...
                                    response.historicoCarro.dados_veiculo.cilindradas
                                ) {
                                    motoCilindradas
                                        .val(response.historicoCarro.dados_veiculo.cilindradas)
                                        .trigger('input');
                                }
